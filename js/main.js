(function () {
  ...
  const items = document.querySelectorAll(
    ".services__bonus-item, .content__examples-laptop, .content__examples-billboard, .content__examples-booklet, .content__examples-roll-up, .content__examples-demo, .content__examples-table, .content__examples-media"
  );
  ...
  document.querySelectorAll(".accordion-list__control").forEach((control) => {
    control.addEventListener("click", function (e) {
      ...
      const slide = document.querySelector(
        `.content-block__slide[data-key="${key}"]`
      );
  ...
  function updateCustomScrollbar(activeIndex, sliderType) {
    const rects = document.querySelectorAll(
      `.custom-scrollbar-rect[data-slider="${sliderType}"]`
    );
